...
import com.talos.test.constants.TalosTestConstants;
import com.talos.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TalosTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/talostest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/talostest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/talostest/import/cstickets.impex");
			...
			importImpexFile(context, "/talostest/import/csquotes.impex");
		}
	}
}
