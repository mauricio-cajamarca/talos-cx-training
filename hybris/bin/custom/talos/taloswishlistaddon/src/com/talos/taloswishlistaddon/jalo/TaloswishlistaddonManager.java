 ...
 */
package com.talos.taloswishlistaddon.jalo;
...
import com.talos.taloswishlistaddon.constants.TaloswishlistaddonConstants;



/**
 * This is the extension manager of the Taloswishlistaddon extension.
 */
public class TaloswishlistaddonManager extends GeneratedTaloswishlistaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(TaloswishlistaddonManager.class.getName());
	 ...
	 */
	public static TaloswishlistaddonManager getInstance()
	{
		return (TaloswishlistaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				TaloswishlistaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TaloswishlistaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TaloswishlistaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of TaloswishlistaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of TaloswishlistaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
