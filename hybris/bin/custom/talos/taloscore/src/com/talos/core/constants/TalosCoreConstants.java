 ...
 */
package com.talos.core.constants;

/**
 * Global class for all TalosCore constants. You can add global constants for your extension into this class.
 */
public final class TalosCoreConstants extends GeneratedTalosCoreConstants
{
	public static final String EXTENSIONNAME = "taloscore";


	private TalosCoreConstants()
	{
		//empty
	}
