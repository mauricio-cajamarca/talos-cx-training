...
public class DefaultTaloswishlistService implements TaloswishlistService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTaloswishlistService.class);
	...
	{
		return DefaultTaloswishlistService.class.getResourceAsStream("/taloswishlist/sap-hybris-platform.png");
	}
