 ...
 */
package com.talos.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TalosFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TalosFulfilmentProcessConstants.PARENT_PROCESS);
