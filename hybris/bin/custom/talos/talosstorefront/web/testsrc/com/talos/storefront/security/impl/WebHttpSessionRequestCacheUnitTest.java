...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/talosstorefront/electronics/en",
						"https://electronics.local:9002/talosstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/talosstorefront/electronics/en",
						"https://electronics.local:9002/talosstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/talosstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/talosstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/talosstorefront/electronics/en",
						"https://electronics.local:9002/talosstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/talosstorefront",
						"https://electronics.local:9002/talosstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/talosstorefront",
						"https://electronics.local:9002/talosstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/talosstorefront/electronics/en",
						"https://electronics.local:9002/talosstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
